...
public class PathResolver implements IBuildPathResolver {
	...
	// TODO: install Yagarto and check registry key
	private static final String REGISTRY_KEY = "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Yagarto XXXX"; //$NON-NLS-1$ 
